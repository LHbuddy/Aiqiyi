...
public class DaoHangActivity extends BaseActivity {
    ...
    private String[] names = new String[]{"综艺", "动漫", "电视剧", "电影", "搞笑", "娱乐", "新闻", "记录片", "体育", "做饭", "游戏", "学校考试", "汽车", "科技", "自媒体", "明星", "出品人"};
